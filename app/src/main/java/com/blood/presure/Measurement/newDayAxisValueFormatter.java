...
public class newDayAxisValueFormatter extends ValueFormatter {
    private final BarLineChartBase<?> chart;
    private final String[] mMonths = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
    List<NewrecordPressure> records = new ArrayList();
    ...
    public newDayAxisValueFormatter(BarLineChartBase<?> barLineChartBase) {
    ...
    public String getFormattedValue(float f) {
        ...
        return this.records.size() > i ? getValueString(this.records.get(i).time) : "";
    }
    ...
    private int getDaysForMonth(int i, int i2) {
        throw new UnsupportedOperationException("Method not decompiled: com.BPM.utils.DayAxisValueFormatter.getDaysForMonth(int, int):int");
    }
    ...
    public void setDate(List<NewrecordPressure> list) {
        this.records = list;
    }
}
